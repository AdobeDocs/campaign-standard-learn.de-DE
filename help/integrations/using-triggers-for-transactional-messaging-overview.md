...
2. [Trigger in Experience Cloud erstellen](https://experienceleague.adobe.com/de/docs/core-services/interface/triggers)
3. [Erstellen eines Trigger-Ereignisses in Campaign Standard](/help/integrations/create-a-trigger-event.md)

Nachdem der Trigger konfiguriert ist, können Sie [Transaktionsnachrichten mithilfe von Echtzeit-Ereignisdaten konfigurieren](/help/integrations/configure-transactional-messages-using-realtime-event-data.md).
